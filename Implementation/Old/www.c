...
#define NEWLINE_PROMPT 0            /* @@ This shuld not be needed */ 
                                    /* Used to flush out prompt line before 
                                       user input */
/* Include Files */
/* ============= */
...
*/
PRIVATE para_style     normal_style     = { 3,  3, 75, 0, 0, 0, 0,  0, 0};

PRIVATE para_style     list_style       = { 7, 10, 75, 0, 0, 0, 0,  1, 1};

PRIVATE para_style     glossary_style   = { 7, 27, 75, 0, 0, 0, 0,  1, 1};

PRIVATE para_style     mono_style       = { 0,  0, 80, 0, 0, 0, 0,  0, 0};

PRIVATE para_style     address_style    = { 4,  4, 75, 1, 0, 0, 0,  0, 0};

PRIVATE para_style     heading_style[7] = {

/* TITLE */				  { 0,  0, 75, 1, 0, 0, 0,  0, 1},


/* H1 */                                  { 0,  0, 80, 2, 1, 1, 0,  1, 1},

/* H2 */                                  { 0,  0, 80, 0, 1, 1, 0,  0, 0},

/* H3 */                                  { 2,  2, 80, 0, 0, 0, 0,  0, 0},

/* H4 */                                  { 4,  4, 80, 0, 0, 0, 0,  0, 0},

/* H5 */                                  { 6,  6, 80, 0, 0, 0, 0,  0, 0},

/* H6 */                                  { 8,  8, 80, 0, 0, 0, 0,  0, 0},
...
**					   L1  L2  R      1  2 spac B4 After
*/
PRIVATE para_style     normal_style     = { 5,  4, 75, 0, 0, 0, 0,  0, 0};

PRIVATE para_style     list_style       = {10, 10, 75, 0, 0, 0, 0,  1, 1};

PRIVATE para_style     glossary_style   = {10, 30, 75, 0, 0, 0, 0,  1, 1};

PRIVATE para_style     mono_style       = { 0,  0, 75, 0, 0, 0, 0,  1, 1};

PRIVATE para_style     address_style    = { 5,  4, 75, 1, 0, 0, 0,  0, 0};

PRIVATE para_style     heading_style[7] = {

/* TITLE */				  { 10, 10, 70, 2, 1, 1, 1,  1, 1},

/* H1 */                                  {  2,  2, 75, 0, 1, 1, 1,  1, 1},

/* H2 */			          {  4,  4, 75, 0, 1, 1, 0,  1, 0},

/* H3 */			          {  4,  4, 75, 0, 0, 0, 0,  1, 0},

/* H4 */			          {  4,  4, 75, 0, 0, 0, 0,  1, 0},

/* H5 */			          {  4,  4, 75, 0, 0, 0, 0,  1, 0},

/* H6 */			          {  4,  4, 75, 0, 0, 0, 0,  1, 0},
...
**                                         L1  L2  R      1  2 spac B4 After
*/
PRIVATE para_style     normal_style     = { 3,  3, 80, 0, 0, 0, 0,  0, 0};

PRIVATE para_style     list_style       = { 7, 10, 80, 0, 0, 0, 0,  1, 1};

PRIVATE para_style     glossary_style   = { 7, 27, 80, 0, 0, 0, 0,  1, 1};

PRIVATE para_style     mono_style       = { 0,  0, 80, 0, 0, 0, 0,  0, 0};

PRIVATE para_style     address_style    = { 4,  4, 80, 1, 0, 0, 0,  0, 0};

PRIVATE para_style     heading_style[7] = {

/* TITLE */                               { 0,  0, 80, 1, 0, 0, 0,  0, 1},
              ...
              
{
	...
	if (!((position_in_line==0)&& (WHITE_SPACE(character)))){
	    ...
	    if (both_indent) {
		line_length = ((current_style->right_indent) -
                               (current_style->left_indent1));
	    } else {
		line_length = ((current_style->right_indent) - (left_indent));
	    }
...

{
    ...
    if (current_style->alignment==1) {
        line_start = (current_style->right_indent) - position_in_line;
    }
    if (current_style->alignment==2) { 
        line_start = ((current_style->right_indent)+(left_indent)-
                      (position_in_line+1))/2;
    }
...
{   
    ...
    }                           /* NEWLINE_PROMPT needs setting up, not here */
